package com.sherry.leetcode._0008_StringtoInteger.mine;
...
public class StringtoInteger {
    ...
    public int myAtoi(String str) {
        ...
        //  无法转换的情况
        if (str.length() == 0 || !Pattern.compile("^[(0-9)|\\-|\\+]").matcher(str.substring(0, 1)).matches()) {
            return 0;
        }
        ...
        for (; rRange < str.length(); rRange++) {
            ...
            try {
                result = Integer.valueOf(str.substring(0, rRange + 1));
            } catch (Exception e) {
